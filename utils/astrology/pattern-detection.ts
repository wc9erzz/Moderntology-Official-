...
// Helper to collect aspects between a set of planets
function collectAspects(planets: string[], data: ChartData): PatternResult['aspects'] {
        ...
        for (const planet of signPlanets) {
            ...
            if (component.length >= 3) {
                results.push({
                    ...
                    tier: 'basic',
                    aspects: collectAspects(component, data)
                });
            }
        }
    });
                ...
                if (isConnected) {
                    ...
                    if (!foundTrines.has(key)) {
                        ...
                        results.push({
                            ...
                            tier: 'basic',
                            aspects: collectAspects(sorted, data)
                        });
                    }
                }
            }
                    ...
                    if (isOpposite) {
                        ...
                        if (!foundTSquares.has(key)) {
                            ...
                            results.push({
                                ...
                                tier: 'basic',
                                aspects: collectAspects([apex, pA, pB], data)
                            });
                        }
                    }
                }
            ...
            if (isSquare1 && isSquare2) {
                ...
                if (!foundCrosses.has(key)) {
                    ...
                    results.push({
                        ...
                        tier: 'expert',
                        aspects: collectAspects(allPlanets, data)
                    });
                }
            }
        }
            ...
            if (sextiles >= 2 && oppositions >= 1) {
                ...
                if (!results.some(r => r.id === key)) {
                    results.push({
                        ...
                        style: getStyle('Kite'),
                        tier: 'expert',
                        aspects: collectAspects(kitePlanets, data)
                    });
                }
            }
        });
            ...
            if (sextileCount === 2 && trineCount === 2) {
                ...
                if (!results.some(r => r.id === key)) {
                    results.push({
                        ...
                        tier: 'expert',
                        aspects: collectAspects(all, data)
                    });
                }
            }
        }
    ...
    Object.keys(parallels).forEach(p => {
        ...
        if (cluster.size >= 2) {
            ...
            results.push({
                ...
                tier: 'basic',
                aspects: collectAspects(planets, data)
            } as any);
        }
    });
